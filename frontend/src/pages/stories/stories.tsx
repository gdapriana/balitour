...
const Stories = () => {
  ...
  const [allStories, setAllStories] = useState<Story[] | undefined>();
  const [filteredStories, setFilteredStories] = useState<Story[] | undefined>();
      ...
      <div className="flex p-4 justify-center w-full items-center">
        <div className="w-full my-10 max-w-5xl gap-12 flex justify-center items-start">
          ...
          >
            ...
            {filteredStories?.length === 0 && <NotFound title="Stories" />}
