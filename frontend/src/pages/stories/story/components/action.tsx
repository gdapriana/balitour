      ...
      {authenticated ? (
        <>
          {saved ? (
            <UnsaveAlert
              ...
              itemName={story?.name}
              token={token!}
              savedCount={story?._count.users_save_stories}
            />
          ) : (
            <SaveAlert
              object="stories"
          ...
          {liked ? (
            <UnlikeAlert
              ...
              itemName={story?.name}
              token={token!}
              likedCount={story?._count.users_like_stories}
            />
          ) : (
            <LikeAlert
              object="stories"
          ...
          <Button asChild className="rounded-full">
            <a href="#comment">
              <MessageCircle />
              {story?._count.users_comment_stories} <span className="hidden md:inline">Users commented</span>
            </a>
          </Button>
        </>
      ) : (
        <>
          <Button asChild className="rounded-full">
            <Link to="/login">
              <Bookmark />
              {story?._count.users_save_stories} <span className="hidden md:inline">Users saved</span>
            </Link>
          </Button>
          <Button asChild className="rounded-full">
            <Link to="/login">
