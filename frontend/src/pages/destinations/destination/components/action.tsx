      ...
      {authenticated ? (
        <>
          {saved ? (
            <UnsaveAlert
              ...
              token={token!}
              savedCount={destination?._count.users_save_destinations}
            />
          ) : (
            <SaveAlert
              object="destinations"
          ...
          {liked ? (
            <UnlikeAlert
              ...
              itemName={destination?.name}
              token={token!}
              likedCount={destination?._count.users_like_destinations}
            />
          ) : (
            <LikeAlert
              object="destinations"
          ...
          <Button asChild className="rounded-full">
            <a href="#comment">
              <MessageCircle />
              {destination?._count.users_comment_destinations} <span className="hidden md:inline">Users commented</span>
            </a>
          </Button>
        </>
      ) : (
        <>
          <Button asChild className="rounded-full">
            <Link to="/login">
              <Bookmark />
              {destination?._count.users_save_destinations} <span className="hidden md:inline">Users saved</span>
            </Link>
          </Button>
          <Button asChild className="rounded-full">
            <Link to="/login">
