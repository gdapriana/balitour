      ...
      {authenticated ? (
        <>
          {saved ? (
            <UnsaveAlert
              ...
              token={token!}
              savedCount={culture?._count.users_save_cultures}
            />
          ) : (
            <SaveAlert
              object="cultures"
          ...
          {liked ? (
            <UnlikeAlert
              ...
              itemName={culture?.name}
              token={token!}
              likedCount={culture?._count.users_like_cultures}
            />
          ) : (
            <LikeAlert
              object="cultures"
          ...
          <Button asChild className="rounded-full">
            <a href="#comment">
              <MessageCircle />
              {culture?._count.users_comment_cultures} <span className="hidden md:inline">Users commented</span>
            </a>
          </Button>
        </>
      ) : (
        <>
          <Button asChild className="rounded-full">
            <Link to="/login">
              <Bookmark />
              {culture?._count.users_save_cultures} <span className="hidden md:inline">Users saved</span>
            </Link>
          </Button>
          <Button asChild className="rounded-full">
            <Link to="/login">
